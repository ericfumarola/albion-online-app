...
function (_React$Component) {
  ...
  _createClass(SimpleTabs, [{
    ...
    value: function render() {
      var classes = this.props.classes; //const {value} = this.state;
      ...
      })))), value === 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(TabContainer, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 52
        }
      }, "Test"), value === 1 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(TabContainer, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 53
        }
...
//# sourceMappingURL=5.6b953641e44fdcf6399f.hot-update.js.map